...
const topicContent = {
  'tc-conv-implicit': (
    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
      <p style={{ color: '#ddd', fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '2rem' }}>
        <strong style={{ color: 'white', fontSize: '1.4rem' }}>Implicit Type Conversion (Coercion):</strong>
      </p>
  ...
  'tc-conv-explicit': (
    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
      <p style={{ color: '#ddd', fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '2rem' }}>
        <strong style={{ color: 'white', fontSize: '1.4rem' }}>Explicit Type Conversion (Casting):</strong>
      </p>
      <div style={{ textAlign: 'center' }}>
        <img src="/cg-seg6-type-conversion-explicit.png" alt="Explicit Type Conversion Definition" style={{ width: '100%', maxWidth: '1000px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.2)' }} />
      </div>
    </div>
  ),
  'tc-conv': (
    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
      <p style={{ color: '#ddd', fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '2rem' }}>
        <strong style={{ color: 'white', fontSize: '1.4rem' }}>Type Conversion:</strong>
      </p>
      <div style={{ textAlign: 'center' }}>
        <img src="/cg-seg6-type-conversion-intro.png" alt="Type Conversion Definition & Types" style={{ width: '100%', maxWidth: '1000px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.2)' }} />
      </div>
    </div>
  ),
  'tc-stmt': (
    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
      <p style={{ color: '#ddd', fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '2rem' }}>
        <strong style={{ color: 'white', fontSize: '1.4rem' }}>Type Checking of Statement:</strong>
      </p>
      <div style={{ textAlign: 'center' }}>
        <img src="/cg-seg6-type-checking-stmt.png" alt="Type Checking of Statement Rules" style={{ width: '100%', maxWidth: '1000px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.2)' }} />
      </div>
    </div>
  ),
  'tc-expr': (
    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
      <p style={{ color: '#ddd', fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '2rem' }}>
        <strong style={{ color: 'white', fontSize: '1.4rem' }}>Type Checking of Expression:</strong>
      </p>
      <div style={{ textAlign: 'center' }}>
        <img src="/cg-seg6-type-checking-expr.png" alt="Type Checking of Expression Rules" style={{ width: '100%', maxWidth: '1000px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.2)' }} />
      </div>
    </div>
  ),
  tc: (
    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '2rem', borderRadius: '12px', border: '1px solid rgba(255,255,255,0.1)' }}>
      <p style={{ color: '#ddd', fontSize: '1.2rem', lineHeight: '1.8', marginBottom: '2rem' }}>
        <strong style={{ color: 'white', fontSize: '1.4rem' }}>Type Checking:</strong>
      </p>
      <div style={{ textAlign: 'center' }}>
        <img src="/cg-seg6-type-checking-intro.png" alt="Type Checking Definition & Concept" style={{ width: '100%', maxWidth: '1000px', borderRadius: '8px', border: '1px solid rgba(255,255,255,0.2)' }} />
      </div>
    </div>
  ),
  sdt: (
