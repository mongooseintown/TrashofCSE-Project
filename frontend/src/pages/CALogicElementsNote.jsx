  ...
  return (
    <div className="note-page-container">
      ...
      <div className="note-images-list">
        {/* Q1 Section */}
        <div className="note-image-card" style={{ marginBottom: '3.5rem' }}>
          <h2 style={{ fontSize: '1.25rem', fontWeight: 650, color: 'var(--text-primary)', marginBottom: '1rem', padding: '0 1rem' }}>
            Question 1: Explain the logic elements for multicycle datapath. (Autumn 2025)
          </h2>
          <div className="note-img-wrapper" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', alignItems: 'center' }}>
            ...
            <img 
              ...
              alt="Answer description for combinational and state logic elements" 
              className="note-handnote-img" 
            />
          </div>
        </div>
        ...
        <div className="note-image-card">
          <h2 style={{ fontSize: '1.25rem', fontWeight: 650, color: 'var(--text-primary)', marginBottom: '1rem', padding: '0 1rem' }}>
            Question 2: How does the execution of different instruction types differ in multi-cycle datapath. Show the steps. (Spring 2025)
          </h2>
          <div className="note-img-wrapper" style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem', alignItems: 'center' }}>
            <img 
