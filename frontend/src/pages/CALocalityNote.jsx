  ...
  return (
    <div className="note-page-container">
      ...
      <div className="note-header-row">
        ...
        <div>
          <h1>Locality of Reference Notes</h1>
        </div>
      </div>
      ...
      <div className="tlb-pdf-container">
        <div className="tlb-pdf-header-controls">
          <span className="pdf-filename">Locality of Reference.pdf</span>
          <div className="pdf-header-actions">
            ...
            <a 
              href="/ca-locality.pdf" 
              download="CA_Locality_of_Reference.pdf" 
              className="pdf-action-btn" 
              title="Download PDF"
            >
              <Download size={16} />
        ...
        <div className="pdf-frame-wrapper">
          <iframe 
            src="/ca-locality.pdf#toolbar=1" 
            title="Locality Notes PDF"
            width="100%" 
            height="700px" 
        ...
        <div className="pdf-fallback-footer">
          <p>
            ...
            <a href="/ca-locality.pdf" target="_blank" rel="noopener noreferrer"> Click here to open it directly</a> or 
            <a href="/ca-locality.pdf" download="CA_Locality_of_Reference.pdf"> download it</a>.
          </p>
        </div>
      </div>
      ...
      {isFullscreen && (
        <div className="pdf-fullscreen-overlay">
          <div className="fullscreen-header">
            <span className="fullscreen-title">Locality.pdf - Document Viewer</span>
          ...
          <div className="fullscreen-body">
            <iframe 
              src="/ca-locality.pdf#toolbar=1" 
              title="Locality Notes PDF Fullscreen"
              width="100%" 
              height="100%" 
