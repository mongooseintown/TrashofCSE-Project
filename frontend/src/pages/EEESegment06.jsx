    ...
    <div className="eee-container">
      <div className="eee-header" style={{ display: 'flex', alignItems: 'center', gap: '1.5rem' }}>
        ...
        <div>
          ...
          <p>AC Circuits & Phasors — Impedance, Resonance, and Power Analysis.</p>
        </div>
      </div>
      ...
      <div style={{
        ...
        <p style={{ maxWidth: '450px', color: 'var(--text-secondary)', fontSize: '1rem', lineHeight: '1.6' }}>
          Materials for AC Circuits & Phasors are currently being compiled. They will be unlocked shortly.
        </p>
      </div>
    </div>
  );
