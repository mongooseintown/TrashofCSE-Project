  ...
  return (
    <div className="eee-container">
      ...
      <div className="card-grid">
        ...
        {/* Card 15: Thermocouple Previous Questions */}
        <div className="product-card" onClick={() => navigate('/eee/thermocouple-pq')}>
          {/* Card Top Image Cover */}
          <div className="card-img-container">
            <span className="card-tag-badge">New</span>
            <div className="card-logo-badge">EEE</div>
            ...
            <img 
              src="/thermocouple-cover.png" 
              alt="Thermocouple Previous Questions" 
              className="card-img" 
          ...
          {/* Card Content details */}
          <div className="card-details-section">
            <h3>Thermocouple Previous Questions</h3>
            <span className="card-sub">Exam Question Board</span>
            <p className="card-desc">
              Review and practice real previous exam questions on Thermocouple Working Principles.
            </p>
          </div>
        ...
        {/* Card 17: Thermocouple's Math */}
        <div className="product-card" onClick={() => navigate('/eee/thermocouple-math')}>
          {/* Card Top Image Cover */}
          <div className="card-img-container">
            <span className="card-tag-badge">New</span>
            <div className="card-logo-badge">EEE</div>
          ...
          {/* Card Content details */}
          <div className="card-details-section">
            <h3>Thermocouple's Math</h3>
            <span className="card-sub">Exam Question Board</span>
            <p className="card-desc">
              Practice solved mathematical problems on Thermocouple sensors.
            </p>
          </div>
          ...
          <div className="card-footer-row">
            ...
            <button className="buy-pill-btn" onClick={(e) => {
              e.stopPropagation();
              navigate('/eee/thermocouple-math');
            }}>
              Open Note <ArrowUpRight size={16} />
            </button>
          </div>
        ...
        {/* Card 19: Digital Frequency Meter (DFM) / Frequency Counter circuit */}
