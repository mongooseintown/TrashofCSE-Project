    ...
    <div className="note-page-container">
      ...
      <div className="tlb-pdf-container">
        <div className="tlb-pdf-header-controls">
          <span className="pdf-filename">Virtual Memory.pdf</span>
          <div className="pdf-header-actions">
            ...
            <a 
              href="/ca-virtual-memory.pdf" 
              download="CA_Virtual_Memory.pdf" 
              className="pdf-action-btn" 
              title="Download PDF"
            >
              <Download size={16} />
        ...
        <div className="pdf-frame-wrapper">
          <iframe 
            src="/ca-virtual-memory.pdf#toolbar=1" 
            title="Virtual Memory Notes PDF"
            width="100%" 
            height="700px" 
        ...
        <div className="pdf-fallback-footer">
          <p>
            ...
            <a href="/ca-virtual-memory.pdf" target="_blank" rel="noopener noreferrer"> Click here to open it directly</a> or 
            <a href="/ca-virtual-memory.pdf" download="CA_Virtual_Memory.pdf"> download it</a>.
          </p>
        </div>
      </div>
      ...
      {isFullscreen && (
        <div className="pdf-fullscreen-overlay">
          <div className="fullscreen-header">
            <span className="fullscreen-title">Virtual Memory.pdf - Document Viewer</span>
          ...
          <div className="fullscreen-body">
            <iframe 
              src="/ca-virtual-memory.pdf#toolbar=1" 
              title="Virtual Memory Notes PDF Fullscreen"
              width="100%" 
              height="100%" 
...
export default CAVirtualMemoryNote;
