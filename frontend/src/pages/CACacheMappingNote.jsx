  ...
  return (
    <div className="note-page-container">
      ...
      <div className="note-header-row">
        ...
        <div>
          <h1>Cache Mapping Architectures Notes</h1>
        </div>
      </div>
      ...
      <div className="tlb-pdf-container">
        <div className="tlb-pdf-header-controls">
          <span className="pdf-filename">Cache Mapping Architectures.pdf</span>
          <div className="pdf-header-actions">
            ...
            <a 
              href="/ca-cache-mapping.pdf" 
              download="CA_Cache_Mapping_Architectures.pdf" 
              className="pdf-action-btn" 
              title="Download PDF"
            >
              <Download size={16} />
        ...
        <div className="pdf-frame-wrapper">
          <iframe 
            src="/ca-cache-mapping.pdf#toolbar=1" 
            title="Cache Mapping Notes PDF"
            width="100%" 
            height="700px" 
        ...
        <div className="pdf-fallback-footer">
          <p>
            ...
            <a href="/ca-cache-mapping.pdf" target="_blank" rel="noopener noreferrer"> Click here to open it directly</a> or 
            <a href="/ca-cache-mapping.pdf" download="CA_Cache_Mapping_Architectures.pdf"> download it</a>.
          </p>
        </div>
      </div>
      ...
      {isFullscreen && (
        <div className="pdf-fullscreen-overlay">
          <div className="fullscreen-header">
            <span className="fullscreen-title">Cache Mapping.pdf - Document Viewer</span>
          ...
          <div className="fullscreen-body">
            <iframe 
              src="/ca-cache-mapping.pdf#toolbar=1" 
              title="Cache Mapping Notes PDF Fullscreen"
              width="100%" 
              height="100%" 
...
export default CACacheMappingNote;
