  ...
  return (
    <div className="note-page-container">
      ...
      <div className="note-header-row">
        ...
        <div>
          <h1>Pipelining & Hazards Notes</h1>
        </div>
      </div>
      ...
      <div className="tlb-pdf-container">
        <div className="tlb-pdf-header-controls">
          <span className="pdf-filename">Segment 6(Architecture).pdf</span>
          <div className="pdf-header-actions">
            ...
            <a 
              href="/ca-segment-06.pdf" 
              download="CA_Segment06_Pipelining_Hazards.pdf" 
              className="pdf-action-btn" 
              title="Download PDF"
            >
              <Download size={16} />
        ...
        <div className="pdf-frame-wrapper">
          <iframe 
            src="/ca-segment-06.pdf#toolbar=1" 
            title="Pipelining & Hazards Notes PDF"
            width="100%" 
            height="700px" 
        ...
        <div className="pdf-fallback-footer">
          <p>
            ...
            <a href="/ca-segment-06.pdf" target="_blank" rel="noopener noreferrer"> Click here to open it directly</a> or 
            <a href="/ca-segment-06.pdf" download="CA_Segment06_Pipelining_Hazards.pdf"> download it</a>.
          </p>
        </div>
      </div>
      ...
      {isFullscreen && (
        <div className="pdf-fullscreen-overlay">
          <div className="fullscreen-header">
            <span className="fullscreen-title">Segment 6(Architecture).pdf - Document Viewer</span>
          ...
          <div className="fullscreen-body">
            <iframe 
              src="/ca-segment-06.pdf#toolbar=1" 
              title="Pipelining & Hazards Notes PDF Fullscreen"
              width="100%" 
              height="100%" 
...
export default CAPipeliningNote;
