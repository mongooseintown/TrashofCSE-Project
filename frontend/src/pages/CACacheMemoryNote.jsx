  ...
  return (
    <div className="note-page-container">
      ...
      <div className="note-header-row">
        ...
        <div>
          <h1>Cache Memory & Terminology Notes</h1>
        </div>
      </div>
      ...
      <div className="tlb-pdf-container">
        <div className="tlb-pdf-header-controls">
          <span className="pdf-filename">Cache Memory & Terminology.pdf</span>
          <div className="pdf-header-actions">
            ...
            <a 
              href="/ca-cache-memory.pdf" 
              download="CA_Cache_Memory_Terminology.pdf" 
              className="pdf-action-btn" 
              title="Download PDF"
            >
              <Download size={16} />
        ...
        <div className="pdf-frame-wrapper">
          <iframe 
            src="/ca-cache-memory.pdf#toolbar=1" 
            title="Cache Memory Notes PDF"
            width="100%" 
            height="700px" 
        ...
        <div className="pdf-fallback-footer">
          <p>
            ...
            <a href="/ca-cache-memory.pdf" target="_blank" rel="noopener noreferrer"> Click here to open it directly</a> or 
            <a href="/ca-cache-memory.pdf" download="CA_Cache_Memory_Terminology.pdf"> download it</a>.
          </p>
        </div>
      </div>
      ...
      {isFullscreen && (
        <div className="pdf-fullscreen-overlay">
          <div className="fullscreen-header">
            <span className="fullscreen-title">Cache Memory.pdf - Document Viewer</span>
          ...
          <div className="fullscreen-body">
            <iframe 
              src="/ca-cache-memory.pdf#toolbar=1" 
              title="Cache Memory Notes PDF Fullscreen"
              width="100%" 
              height="100%" 
...
export default CACacheMemoryNote;
