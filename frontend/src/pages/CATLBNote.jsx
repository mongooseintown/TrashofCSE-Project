...
import { ArrowLeft, Maximize2, Minimize2, Download, ExternalLink, Info } from 'lucide-react';
...
const CATLBNote = () => {
  ...
  // Lock scroll when in fullscreen mode
  useEffect(() => {
    if (isFullscreen) {
    ...
    <div className="note-page-container">
      ...
      <div className="tlb-pdf-container">
        <div className="tlb-pdf-header-controls">
          <span className="pdf-filename">CA TLB.pdf</span>
        ...
        <div className="pdf-fallback-footer">
          <p>
            ...
            <a href="/ca-tlb.pdf" target="_blank" rel="noopener noreferrer"> Click here to open it directly</a> or 
            <a href="/ca-tlb.pdf" download="CA_TLB.pdf"> download it</a>.
          </p>
        </div>
      </div>
      ...
      {isFullscreen && (
        <div className="pdf-fullscreen-overlay">
          <div className="fullscreen-header">
            <span className="fullscreen-title">CA TLB.pdf - Document Viewer</span>
          ...
          <div className="fullscreen-body">
            <iframe 
              src="/ca-tlb.pdf#toolbar=1" 
              title="TLB Notes PDF Fullscreen"
              width="100%" 
              height="100%" 
